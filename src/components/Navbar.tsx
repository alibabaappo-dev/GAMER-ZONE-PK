...
import { Bell, Menu, X,Coins,Wallet as WalletIcon, LayoutDashboard, Trophy, Star, BarChart2, FileText, Wallet, ArrowUpDown, History, MessageSquare, LogOut, ArrowLeft, ChevronRight, User, Check, Clock, ArrowDownLeft, ArrowUpRight, Trash2, Gift, Home as HomeIcon, Award, ChevronLeft } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 h-20 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-6">
            <Link to="/wallet" className="flex items-center gap-2 bg-[#1C1C1E] px-4 py-2 rounded-full border border-gray-800 hover:border-yellow-500/50 transition-all">
             <Coins size={23} className="mr-2 text-yellow-400" />
