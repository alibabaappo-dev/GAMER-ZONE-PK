...
export default function Login() {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      setResetSent(true);
      setError('');
      setForgotPasswordStep(2); // Go to code verification
    } catch (err: any) {
        ...
        <div className="w-full max-w-[380px] bg-[#151B28]/90 backdrop-blur-xl border border-white/5 rounded-[2rem] p-6 lg:p-8 shadow-2xl">
          <div className="flex justify-center mb-6">
            <div className="flex flex-col items-center justify-center">
              <img src="https://i.ibb.co/JwjG5968/logo.png" alt="" className="h-23 w-auto border border-transparent rounded-sm" />
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {resetSent && (
                <div className="bg-green-500/10 border border-green-500/20 p-3 rounded-xl text-green-500 text-[10px] font-medium text-center break-words">
                  Verification code sent successfully! Check your email for the 4-digit code.
                </div>
              )}
